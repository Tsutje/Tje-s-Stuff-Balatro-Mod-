SMODS.Joker{
    ...
    calculate = function(self, card, context)
        if context.setting_blind and G.GAME.dollars+(G.GAME.dollar_buffer or 0) >= card.ability.extra.wishcost and #G.jokers.cards + G.GAME.joker_buffer < G.jokers.config.card_limit then
